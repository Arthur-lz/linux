...
enum RTL8168_register_content {
        ...
        /* GPIO */
        GPIO_en = (1 << 0), // 左移0位，神经病, 直接写1不行吗!

};

enum _DescStatusBit {
        DescOwn     = (1 << 31), /* Descriptor is owned by NIC */ // 1左移31位=0x80000000, 7个0代表28, 31-28=3, 2的3次方=8
        RingEnd     = (1 << 30), /* End of descriptor ring */     // 1左移30位=0x40000000, 7个0代表28, 30-28=2, 2的2次方=4
        FirstFrag   = (1 << 29), /* First segment of a packet */  // 1左移29位=0x20000000, 7个0代表28, 29-28=1, 2的1次方=2
        LastFrag    = (1 << 28), /* Final segment of a packet */  // 0x10000000

        /* Tx private */
        /*------ offset 0 of tx descriptor ------*/
        LargeSend   = (1 << 27), /* TCP Large Send Offload (TSO) */ //0x8000000
        GiantSendv4 = (1 << 26), /* TCP Giant Send Offload V4 (GSOv4) */ // 0x4000000
        GiantSendv6 = (1 << 25), /* TCP Giant Send Offload V6 (GSOv6) */ // 0x2000000
        LargeSend_DP = (1 << 16), /* TCP Large Send Offload (TSO) */ // 0x10000
        MSSShift    = 16,        /* MSS value position */
        MSSMask     = 0x7FFU,    /* MSS value 11 bits */
        TxIPCS      = (1 << 18), /* Calculate IP checksum */ // 0x40000
        TxUDPCS     = (1 << 17), /* Calculate UDP/IP checksum */ // 0x20000
        TxTCPCS     = (1 << 16), /* Calculate TCP/IP checksum */ // 0x10000
...
enum bits {
        ...
        BIT_18 = (1 << 18), // 0x40000
        BIT_19 = (1 << 19), // 0x80000
        BIT_20 = (1 << 20), // 0x100000
        BIT_21 = (1 << 21), // 0x200000
        BIT_22 = (1 << 22), // 0x400000
        BIT_23 = (1 << 23), // 0x800000
        BIT_24 = (1 << 24), // 0x1000000
        BIT_25 = (1 << 25), // 0x2000000
        BIT_26 = (1 << 26), // 0x4000000
        BIT_27 = (1 << 27), // 0x8000000
        BIT_28 = (1 << 28), // 0x10000000
        BIT_29 = (1 << 29), // 0x20000000
        BIT_30 = (1 << 30), // 0x40000000
        BIT_31 = (1 << 31)  // 0x80000000
};
...
struct rtl8168_private {
        ...
        spinlock_t lock;        // 自旋锁/* spin lock flag */
        u32 msg_enable;
        u32 tx_tcp_csum_cmd;
        u32 tx_udp_csum_cmd;
        u32 tx_ip_csum_cmd;
        ...
        struct sk_buff *Rx_skbuff[NUM_RX_DESC];// 这个狠，定义的是套接字结构类型的指针数组，要收多大的数据啊 /* Rx data buffers */
